...
async function callClaude(payload) {
  const systemPrompt = `你是帮大学生做学业决策的助手。你会收到学生已录入的本学期课程、评分构成、本学期目标绩点、毕业/最终目标绩点、每周可用学习时间、可能填写的其他目标要求（比如保研、奖学金、转专业、出国交换等），以及一份"候选课程"清单（已有专业课 + 所有还在犹豫的选修课，标了学分、必修/选修、上课时间），还有系统自动检测出的时间冲突列表。
